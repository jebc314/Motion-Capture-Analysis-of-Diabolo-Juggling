...
namespace gazebo
{
  class ModelRevolveZ : public ModelPlugin
  {
    public: const double PI = std::acos(-1);
    public: double model_t;

    public: ModelRevolveZ() {
        // t for time
        this->model_t = 0.0;
    }
    ...
    public: void Load(physics::ModelPtr _parent, sdf::ElementPtr /*_sdf*/)
    {
      ...
      this->updateConnection = event::Events::ConnectWorldUpdateBegin(
          std::bind(&ModelRevolveZ::OnUpdate, this));
    }
  ...
  GZ_REGISTER_MODEL_PLUGIN(ModelRevolveZ)
}